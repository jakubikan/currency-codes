(function (root, undefined) {
    ...
    var lib = {
        ...
        countries: function () {
            ...
            var m = _.pluck(data, 'countries');
            var countries = _.unique(_.compact(_.flatten(m)));
    ...
    if (typeof exports !== 'undefined') {
        ...
        lib.noConflict = (function (previousCury) {
            return function () {
                ...
                root.CurrencyCodes = previousCury;
